...
This blog (`blog.comptech-lab.com`) is built with Astro and deployed via Pages. The deploy is a `git push`; the build runs in GitHub Actions; the output is uploaded to Pages via the `wrangler-action`.
