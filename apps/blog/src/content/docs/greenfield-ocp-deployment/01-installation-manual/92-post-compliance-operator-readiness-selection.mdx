...
decision, the `OP-GF-OPERATORS-20` batch model, and the
`OP-GF-OPERATORS-21` Pipelines Batch 1 execution,
`OP-GF-OPERATORS-22` observability foundation Batch 2 execution, and
`OP-GF-OPERATORS-23` tracing/mesh Batch 3 execution so the manual keeps one
