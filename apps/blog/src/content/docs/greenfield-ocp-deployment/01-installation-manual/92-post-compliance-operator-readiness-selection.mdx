...
| 4 | `OP-GF-OPERATORS-24` | `spoke-dc-v7` | Open Liberty and app-facing CloudNativePG | Next. Requires tenant, backup/restore, image supply, and RHACS exception decisions. |
...
```text
OP-GF-OPERATORS-24: Batch 4 app platform - Open Liberty and app-facing CloudNativePG
```
