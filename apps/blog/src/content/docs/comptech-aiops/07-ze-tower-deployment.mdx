...
The LAN portal exposure uses the same portal API boundary. Final public-safe verification will record direct portal health, readiness, and browser-render checks without publishing credentials or private evidence.
