...
Canonical issue [#36](https://github.com/comptech-lab/comptech-aiops/issues/36) adds deterministic RAG embeddings and Qdrant indexing.
Canonical issue [#37](https://github.com/comptech-lab/comptech-aiops/issues/37) adds the first reviewed RAG knowledge pack and retrieval evaluation fixture.
Canonical issue [#38](https://github.com/comptech-lab/comptech-aiops/issues/38) adds the first operator chat console.
