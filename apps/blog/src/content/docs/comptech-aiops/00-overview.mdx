...
The first encrypted `ze-tower` control-plane backup and restore drill has completed. The public record only names the toolchain and validation outcome; private endpoint values, credentials, and raw evidence remain out of the blog.
