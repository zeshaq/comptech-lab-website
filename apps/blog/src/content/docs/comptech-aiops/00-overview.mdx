...
The current Phase 1 control plane is deployed to `ze-tower` through a manual GitHub Actions workflow and Docker Compose. The baseline includes a custom operator portal MVP, Go/Gin API, React/Vite frontend, Temporal, OPA, LiteLLM, Qdrant, Postgres, Keycloak, NetBox, observability services, placeholder agent/MCP processes, and a RAG ingestion service with durable metadata.
